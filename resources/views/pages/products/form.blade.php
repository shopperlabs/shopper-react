...
@section('title', (isset($record->id)) ? __('Edit product') : __('New product'))
...
@section('content')
    ...
    <div class="wrapper-md">
        <div class="pull-left">
            <div class="btn-group btn-breadcrumb breadcrumb-default">
                ...
                <a href="{{ route('shopper.catalogue.products.index') }}" class="btn btn-default visible-lg-block visible-md-block">{{ __('Products list') }}</a>
                <div class="btn btn-info"><b>{{ (isset($record->id)) ? __('Edit product') : __('New product') }}</b></div>
            </div>
        </div>
    ...
    <div id="product-form" data-id="@if(isset($record)) {{ $record->id }} @endif"></div>
