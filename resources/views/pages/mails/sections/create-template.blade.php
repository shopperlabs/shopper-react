...
@section('content')
    ...
    <div class="wrapper-md">
        <div class="btn-group btn-breadcrumb breadcrumb-default">
            ...
            <div class="btn btn-default"><b>{{ ucfirst($skeleton['type']) }}</b></div>
            <div class="btn btn-default"><b>{{ ucfirst($skeleton['name']) }}</b></div>
            <div class="btn btn-info"><b>{{ ucfirst($skeleton['skeleton']) }}</b></div>
        </div>
    </div>
    ...
    <section class="wrapper-md">
        ...
        <div class="card mb-2">
            <div class="card-header p-3" style="border-bottom:1px solid #e7e7e7e6;">
                <button type="button" class="btn btn-primary float-right save-template">{{ __('Create') }}</button>
        ...
        <div class="card">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">{{ __('Plain Text') }}</a>
                </li>
            </ul>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.save-template').click(function() {
                ...
                notie.input({
                    text: "{{ __('Enter the template name:') }}",
                    type: 'text',
                    ...
                    submitCallback: function (templatename) {
                        ...
                        notie.input({
                            ...
                            text: '{{ __('Enter the template description:') }}',
                            type: 'text',
                            submitText: '{{ __('Create Template') }}',
                            ...
                            submitCallback: function (templatedescription) {
                                ...
                                axios
                                    .post('{{ route('shopper.settings.mails.templates.createNewTemplate') }}', postData)
