...
namespace Mckenziearts\Shopper\Core\Facebook;
...
class Api
{
    ...
    {
        self::$app_id = Config::get('shopper.facebook.app_id');
        self::$app_secret = Config::get('shopper.facebook.app_secret');
        self::$default_graph_version = Config::get('shopper.facebook.default_graph_version');
        self::$page_access_token = Config::get('shopper.facebook.page_access_token');
