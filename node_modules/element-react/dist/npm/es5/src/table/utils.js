...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(isObject, 'isObject', 'src/table/utils.js');

  __REACT_HOT_LOADER__.register(isArray, 'isArray', 'src/table/utils.js');

  __REACT_HOT_LOADER__.register(deepCompare, 'deepCompare', 'src/table/utils.js');
}();
